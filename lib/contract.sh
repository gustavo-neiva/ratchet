...
CONTRACT_KEYS="MODELS TURN_TIMEOUT SHORT_SLEEP MAX_TRANSIENT COOLDOWN BOTH_WAIT \
...
THINKING_PLAN THINKING_BUILD THINKING_LIGHT"
  ...
  while IFS= read -r line || [ -n "$line" ]; do
    ...
    case "$line" in
      [A-Z_]*=*)
        ...
        case "$key" in
          TURN_TIMEOUT|SHORT_SLEEP|MAX_TRANSIENT|COOLDOWN|BOTH_WAIT|TAIL_LINES|HEARTBEAT|\
